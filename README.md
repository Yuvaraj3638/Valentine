...
📁 Project Structure
Project/ │ ├── index.html ├── style.css ├── script.js │ └── assets/ ├── audio/ │ ├── romantic.mp3 │ └── sad.mp3 │ ├── gifs/ │ ├── beg1.webp │ ├── beg2.webp │ ├── cry.webp │ ├── kill.webp │ ├── last.webp │ ├── please.webp │ │ │ ├── dateGifs/ │ │ ├── eve-walk.webp │ │ ├── street-food.webp │ │ ├── watching-movie.webp │ │ ├── long-drive.webp │ │ └── kill.webp │ │ │ └── Envelopes/ │ ├── envelope-closed-flowers.webp │ ├── envelope-opening-flowers.gif │ ├── envelope-closed-memories.gif │ ├── envelope-opening-memories.gif │ ├── envelope-closed-letter.png │ └── envelope-opening-letter.png │ └── images/ ├── flowers/ │ ├── 1.gif │ ├── 2.webp │ ├── 3.webp │ ├── 4.webp │ └── 5.webp │ ├── Letter/ │ └── Letter.jpg │ └── memories/ ├── 1.jpeg ├── 2.jpeg ├── 3.jpeg └── ...

🚀 How to Run
Clone or download the repository
Open index.html in any modern browser
Make sure audio autoplay is enabled for best experience
